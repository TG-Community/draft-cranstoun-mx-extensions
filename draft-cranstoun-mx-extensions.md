...
## Private extension fields (`x-mx-p-`)
...
## Extension field naming in non-YAML contexts
...
# Carrier format mappings

## `.cog.md` — YAML frontmatter
...
## `.cog.png` / `.cog.jpg` — EXIF/XMP metadata
...
## Database sidecars and inline SQL
...
# Field definitions — mx:* non-YAML identity fields
...
# Field definitions — x-mx- public extension fields
...
# x-mx-p- private extension mechanism
...
## How to add new extension fields
...
Tom Cranstoun and Maxine (CogNovaMX). Machine-readable field dictionary: mx-canon/ssot/fields-data.yaml.
